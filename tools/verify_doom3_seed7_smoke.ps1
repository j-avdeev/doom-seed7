...
Assert-FileContains -Path "doom3_seed7_engine.s7" -Needle "projectPointClamped" -Label "near-plane wall clipping"
...
Assert-TextContains -Text $visualText -Needle "visual_smoke_wall_clip=near_plane_clamped" -Label "visual smoke"
